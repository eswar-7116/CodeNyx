  ...
  "DAY ONE": [
    {
      ...
      subtitle: "Participant welcome and refreshments on arrival.",
    },
    {
      time: "10:00 AM - 1:00 PM",
      title: "Problem Statement Discussion",
      duration: "3H",
      subtitle:
        "Teams interact with mentors and understand problem statements.",
    },
    {
      time: "1:00 PM - 2:00 PM",
      title: "Lunch Break",
      duration: "1H",
      subtitle: "Lunch served for all participants.",
    },
    {
      time: "2:00 PM - 5:30 PM",
      title: "Implementation Phase",
      duration: "3.5H",
      subtitle: "Teams begin building their core solutions.",
    },
    {
    ...
    },
    {
      ...
      title: "Continued Implementation",
      duration: "2.5H",
      subtitle: "Teams continue development and mentor discussions.",
    },
    {
      time: "8:30 PM - 10:00 PM",
      title: "Dinner Break",
      duration: "1.5H",
      subtitle: "Dinner served for all participants.",
    },
    {
      time: "10:00 PM - 1:00 AM",
      title: "Overnight Coding",
      duration: "3H",
      subtitle: "Teams continue building their projects overnight.",
    },
    {
      time: "1:00 AM - 3:00 AM",
      title: "Fun Activities / Ice-Breaking Session",
      duration: "2H",
      subtitle: "Optional networking and fun activities for participants.",
    },
  ],
  ...
  "DAY TWO": [
    {
      ...
      title: "Continued Implementation",
      duration: "4H",
      subtitle: "Teams finalize development and features.",
    },
    {
      time: "8:00 AM - 9:30 AM",
      title: "Breakfast",
      duration: "1.5H",
      subtitle: "Breakfast served for participants.",
    },
    {
      time: "9:30 AM - 11:00 AM",
      title: "Final Implementation & Buffer",
      duration: "1.5H",
      subtitle: "Last window for coding and final touches.",
    },
    {
      time: "11:00 AM - 1:00 PM",
      title: "Evaluation Round",
      duration: "2H",
      subtitle: "Judges evaluate all team projects.",
    },
    {
      time: "1:00 PM - 2:00 PM",
      title: "Lunch Break",
      duration: "1H",
      subtitle: "Lunch served for participants.",
    },
    {
      time: "2:00 PM - 4:00 PM",
      title: "Presentation & Closing Ceremony",
      duration: "2H",
      subtitle: "Final presentations followed by results and awards.",
    },
  ],
};

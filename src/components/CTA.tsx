                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center max-w-[700px]">
                        ...
                        <p className="font-body text-[20px] text-accent-primary/50 leading-[1.8] mb-[64px]">
                            Begin your CodeNyx journey by registering for the DSA screening round.
                            Participants will compete individually in an online problem-solving contest.
                            Top performers will move forward to the PPT submission stage and eventually
                            the final 36-hour offline hackathon at CVR College of Engineering.
                        </p>
